...
fastqdir=/hpc/pmc_gen/wjonge/abf1-chipseq/combined_fq
bamdir=/hpc/pmc_gen/wjonge/abf1-chipseq/mapped/bam
outdir=/hpc/pmc_gen/wjonge/abf1-chipseq/mapped/bam
## outdir=.

name="$1"

inbam=$bamdir/$name.namesorted.bam
fq1=$fastqdir/$name-R1.fastq.gz
fq2=$fastqdir/$name-R2.fastq.gz
